...
def prob3():
    ...
    print(len(dataSet))
    badData=dataSet.index('BAD_DATA') # !! : this only grabs ONE instance of BAD_DATA
    print(badData)
    dataSet.pop('BAD_DATA') # !! : assuming this was just a typo but you should be passing in an int or intVariable
    print(dataSet)
    print(len(dataSet))
prob3()
